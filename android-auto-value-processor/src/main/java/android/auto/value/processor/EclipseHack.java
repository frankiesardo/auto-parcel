 ...
 */
package android.auto.value.processor;
 ...
 * {@code @AutoValue} constructor calls like {@code new AndroidAutoValue_Foo(...)} suddenly start being
 ...
 */
class EclipseHack {
  static final String ENABLING_OPTION = "android.auto.value.EclipseHackTest";
