...
/**
 * Generates GWT serialization code for {@code @AutoParcel} classes also marked
...
class GwtSerialization {
  ...
  /**
   * Writes the GWT serializer for the given type, if appropriate. An {@code @AutoParcel} class gets
